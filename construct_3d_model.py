...
DATA_SAVE_DIR = 'data/nominal_pcd/silicone_spatula.ply'
...
if __name__ == '__main__':
    ...
    c3m.write_stitched_pcd(save_path, type = 'object') #  type = hand or object or interest


'''
    plastic : c3m = contruct_3d_model( target_path , icp_threshold =2.5, mode = 'hand', visualize = False) #
